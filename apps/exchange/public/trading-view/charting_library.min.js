!((t, e) => {
  ...
  var e =
    ...
    function (t) {
      for (var e, o = 1, i = arguments.length; o < i; o++)
        for (var n in (e = arguments[o])) Object.hasOwn(e, n) && (t[n] = e[n]);
      return t;
    };
  function o(t, i) {
    var n = e({}, t);
  ...
  var i = {
    ...
    n = {
      ...
      disabled_features: [],
      enabled_features: [],
      favorites: { chartTypes: [], intervals: [] },
      fullscreen: !1,
      height: 500,
      interval: 'D',
      library_path: '',
      ...
      symbol: 'AA',
      time_frames: [
        { resolution: 'W', text: '5y' },
        { resolution: 'W', text: '1y' },
  ...
  var r = (() => {
    ...
    return (
      ...
      (t.prototype.load = function (t, e) {
        this._innerAPI().loadChart({ extendedData: e, json: t });
      }),
        ...
        (this._options.autosize || this._options.fullscreen) &&
          ...
          this._innerWindowLoaded.then(() => {
            this._innerWindow().widgetReady(() => {
              this._ready = !0;
              for (var e = 0, o = this._readyHandlers; e < o.length; e++) {
                var i = o[e];
                try {
                  i.call(this);
                } catch (t) {
