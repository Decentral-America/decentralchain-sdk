...
import ErrorView, { ERROR_TYPES } from '../Error';
...
export class Loader extends React.Component {
    ...
    this.props
      ...
      .catch((error) => {
        ...
        if (this.props.shouldRetry && this.state.retries < MAX_RETRIES) {
          ...
          this.timeoutId = setTimeout(this.doFetch, RETRY_DELAY_MILLISECONDS);
  ...
  render() {
    ...
    if (this.state.hasError) {
      ...
      const title = errorTitles?.[this.state.errorType] || errorTitle;
      return <ErrorView title={title} type={this.state.errorType} />;
    }
