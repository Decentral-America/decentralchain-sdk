import { decompile } from '@decentralchain/ride-js';
  ...
  setDecompiledScript = () => {
    if (this.props.script) {
      try {
        ...
        const decompiledScript = !decompilationResult.error
          ? decompilationResult.result
          : decompilationResult.error;
  ...
  render() {
    return (
      <ScriptInfoView
        ...
        onDisplayFormatChanged={this.handleDisplayFormatChanged}
      />
    );
  }
}
