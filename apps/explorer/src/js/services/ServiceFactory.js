...
class NetworkDependentServices {
  constructor(globalServices, networkId) {
    ...
    this._currencyService = new CurrencyService(
      ...
      new SafeCurrencyCache(database, globalServices.errorReportingService()),
      networkId,
    );
    ...
    this._leaseService = new LeaseService(
  ...
  peersService = () =>
    new PeersService(this._globalServices.configurationService(), this._networkId);

  nodesService = () =>
    new NodesService(this._globalServices.configurationService(), this._networkId);
