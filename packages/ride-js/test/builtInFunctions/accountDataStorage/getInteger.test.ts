...
describe('getInteger', () => {
  ...
  test.each([
    ...
    [
      ...
      getInteger,
      data.GreaterV3ResultIntegerEntry,
      random.getRandomAddress(),
      data.positiveTestType,
    ],
    [
    ...
    [
      data.STDLIB_VERSION_4,
      invalidGetIntegerValueGreaterV3,
      data.GreaterV3ResultIntegerEntry,
      random.getRandomAddress(),
      data.negativeTestType,
    ],
  ...
  test.each([
    ...
    const contract = precondition.generateContractOwnDataWithoutMatcher(
      version,
      scriptResult,
      ownDataGetIntegerValue,
    );
    checkCompileResult(contract, testType);
  });
});
