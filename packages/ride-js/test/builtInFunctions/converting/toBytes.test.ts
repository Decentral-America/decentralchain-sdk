...
describe('toBytes', () => {
  ...
  test.each([[data.STDLIB_VERSION_5, random.getRandomInt(), data.positiveTestType]])(
    'positive: toBytes func compiles for ride v%i at bigInt',
    (version, bigInt, testType) => {
