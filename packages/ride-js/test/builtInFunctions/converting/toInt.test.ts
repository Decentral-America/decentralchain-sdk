...
describe('toInt', () => {
  ...
  test.each([[data.STDLIB_VERSION_5, toIntFunction, random.getRandomInt(), data.positiveTestType]])(
    'check ride v%i function %s compiles or failed',
    (version, testFunction, intData, testType) => {
