...
describe('BLS keygen compatibility test', () => {
  it('should derive correct keys, sign and verify message', () => {
    ...
    const expectedPublicKeyBase58 =
      '7C6PyzoBTrTgNT3nJGUQbRTFCjwQe64wwbkrbtWgQkeR2exLMVLMN82rxZgKjhtmfK';
    ...
    const expectedSignatureBase58 =
      'xhagZTYNfffENgdcyYxWwfbEnU7wRJqVAbxqHKXj1WVDKqr8dvsr2U77WuAbZCFFDzoTbqUaniBNuZftz3eacuudxkqk1khgfAC56uW6EjrYmq63RBqTCj5Rkosjv9t8zwx';
