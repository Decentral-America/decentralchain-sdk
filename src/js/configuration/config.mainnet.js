...
export default {
  ...
  nodes: [
    ...
    { url: 'https://mainnet-node1.decentralchain.io', maintainer: 'DCC', showAsLink: true },
    { url: 'https://mainnet-node2.decentralchain.io', maintainer: 'DCC', showAsLink: true },
  ],
  dappsUrl:
    'https://raw.githubusercontent.com/Decentral-America/dcc-client-config/main/official_dcc_dapps.json',
};
