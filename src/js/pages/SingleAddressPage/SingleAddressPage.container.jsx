import { dccAddress2eth } from '@decentralchain/node-api-js';
...
class SingleAddressPage extends React.Component {
  ...
  fetchData = () => {
    ...
    return addressService.loadBalance(address).then((balance) => this.setState({ balance }));
  };
  ...
  render() {
    ...
    const ethAddress = dccAddress2eth(this.props.params.address);
    return (
      <Loader fetchData={this.fetchData} errorTitle="Failed to load address details">
        <div className="content card">
          ...
          <div className="address-title">
            <Headline
              title="Address"
              subtitle={this.props.params.address}
